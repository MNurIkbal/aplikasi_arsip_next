  ...
  return (
    <form className="space-y-5" onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col items-center justify-center pb-4">
        ...
        <div 
          className={`relative w-28 h-28 rounded-3xl border-2 border-dashed flex items-center justify-center overflow-hidden group cursor-pointer transition-all ${
            errors.image ? "border-red-500 bg-red-50" : "border-gray-200 bg-white hover:border-indigo-400"
          }`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            className={`w-full px-4 py-2.5 bg-white border rounded-xl outline-none focus:ring-2 transition-all ${
              errors.name ? "border-red-500 focus:ring-red-100" : "border-gray-200 focus:ring-indigo-500/20 focus:border-indigo-500"
            }`}
            value={formData.name}
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            className={`w-full px-4 py-2.5 bg-white border rounded-xl outline-none focus:ring-2 transition-all ${
              errors.email ? "border-red-500 focus:ring-red-100" : "border-gray-200 focus:ring-indigo-500/20 focus:border-indigo-500"
            }`}
      ...
      <div className="space-y-1">
        ...
        <div className="relative">
          <input
            ...
            placeholder="••••••••"
            className={`w-full px-4 py-2.5 bg-white border rounded-xl outline-none focus:ring-2 transition-all ${
              errors.password ? "border-red-500 focus:ring-red-100" : "border-gray-200 focus:ring-indigo-500/20 focus:border-indigo-500"
            }`}
